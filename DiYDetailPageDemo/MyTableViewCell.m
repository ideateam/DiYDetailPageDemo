...
//    _model = model;
//
//    //NSLog(@"productImageUrl = %@",model.productImageUrl);
//    [_productImageView sd_setImageWithURL:[NSURL URLWithString:model.productImageUrl] placeholderImage:[UIImage imageNamed:@"1"]];
//    //self.productImageView.image = [UIImage imageNamed:[NSString stringWithContentsOfURL:[NSURL URLWithString:model.productImageUrl] encoding:NSUTF8StringEncoding error:nil]];
//    //
//}
